...
function Login() {
    ...
    return (React.createElement("div", { className: "auth-page" },
        React.createElement("h2", null, "Login to CRNTLY"),
        React.createElement("form", { onSubmit: handleSubmit },
            React.createElement("input", { type: "email", placeholder: "Email", value: email, onChange: function (e) { return setEmail(e.target.value); }, required: true }),
