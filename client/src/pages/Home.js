...
var CreatePost_1 = require("../components/CreatePost");
function Home() {
    var _this = this;
        ...
        var fetchPosts = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, api_1.default.get('/posts')];
                    case 1:
                        data = (_a.sent()).data;
                        setPosts(data);
                        return [3 /*break*/, 3];
    ...
    return (React.createElement("div", { className: "home" },
        ...
        React.createElement("div", { className: "posts-list" }, posts.map(function (post) { return (React.createElement(Post_1.default, __assign({ key: post._id }, post))); }))));
}
